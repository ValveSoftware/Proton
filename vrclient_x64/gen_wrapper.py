...
MANUAL_METHODS = {
    ...
    "IVRSystem_PollNextEvent": lambda ver, abi: abi == 'w' and ver > 10,
    "IVRSystem_PollNextEventWithPose": lambda ver, abi: abi == 'w' and ver > 10,
    ...
    "IVROverlay_PollNextOverlayEvent": lambda ver, abi: abi == 'w' and ver > 9,
