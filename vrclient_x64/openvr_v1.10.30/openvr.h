...
public:
	...
	virtual uint32_t undoc2( uint32_t a, char *b, uint32_t c ) = 0;
	virtual EVRInitError undoc3( const char *a ) = 0;
	virtual uint32_t undoc4( const char *a ) = 0;
	virtual uint32_t undoc5( const char *a , uint32_t b, char *c, uint32_t d ) = 0;
	virtual uint32_t undoc6( const char *a, const char *b, char *c, uint32_t d ) = 0;
	virtual uint32_t undoc7( const char *a, const char *b, char *c, uint32_t d ) = 0;
	virtual bool undoc8( uint32_t a ) = 0;
	virtual void undoc9() = 0;
	virtual void undoc10() = 0;
	virtual bool undoc11( uint32_t a ) = 0;
	virtual void undoc12() = 0;
	virtual void undoc13( TrackedDeviceIndex_t a ) = 0;
	virtual void undoc14( vr::EVRState a ) = 0;
	virtual vr::EVRState undoc15() = 0;
	virtual void undoc16( bool a ) = 0;
	virtual bool undoc17() = 0;
	virtual EVRApplicationError undoc18() = 0;
	virtual void undoc19( bool a ) = 0;
	virtual bool undoc20() = 0;
	virtual EVRInitError undoc21() = 0;
	virtual void undoc22( vr::WebConsoleHandle_t a, const char *b, uint32_t c, uint32_t d, const char *e) = 0;
	virtual bool undoc23( const char *a ) = 0;
	virtual bool undoc24() = 0;
	virtual bool undoc25( bool a ) = 0;
	virtual uint64_t undoc26() = 0;
	virtual EVRCompositorError undoc27( const char *a ) = 0;
	virtual void undoc28( VROverlayHandle_t a ) = 0;
};
...
namespace vr
{
	...
	static const char *IVRMailbox_Version = "IVRMailbox_001";
}
