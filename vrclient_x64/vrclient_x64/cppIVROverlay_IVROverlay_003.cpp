...
extern "C" {
#endif
VROverlayError cppIVROverlay_IVROverlay_003_FindOverlay(void *linux_side, const char *pchOverlayKey, VROverlayHandle_t *pOverlayHandle)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_CreateOverlay(void *linux_side, const char *pchOverlayKey, const char *pchOverlayFriendlyName, VROverlayHandle_t *pOverlayHandle)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_DestroyOverlay(void *linux_side, VROverlayHandle_t ulOverlayHandle)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_SetHighQualityOverlay(void *linux_side, VROverlayHandle_t ulOverlayHandle)
{
    VROverlayError _ret;
...
VROverlayHandle_t cppIVROverlay_IVROverlay_003_GetHighQualityOverlay(void *linux_side)
{
...
VROverlayError cppIVROverlay_IVROverlay_003_GetOverlayImageData(void *linux_side, VROverlayHandle_t ulOverlayHandle, void *pvBuffer, uint32_t unBufferSize, uint32_t *punWidth, uint32_t *punHeight)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_SetOverlayFlag(void *linux_side, VROverlayHandle_t ulOverlayHandle, VROverlayFlags eOverlayFlag, bool bEnabled)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_GetOverlayFlag(void *linux_side, VROverlayHandle_t ulOverlayHandle, VROverlayFlags eOverlayFlag, bool *pbEnabled)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_SetOverlayColor(void *linux_side, VROverlayHandle_t ulOverlayHandle, float fRed, float fGreen, float fBlue)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_GetOverlayColor(void *linux_side, VROverlayHandle_t ulOverlayHandle, float *pfRed, float *pfGreen, float *pfBlue)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_SetOverlayAlpha(void *linux_side, VROverlayHandle_t ulOverlayHandle, float fAlpha)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_GetOverlayAlpha(void *linux_side, VROverlayHandle_t ulOverlayHandle, float *pfAlpha)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_SetOverlayGamma(void *linux_side, VROverlayHandle_t ulOverlayHandle, float fGamma)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_GetOverlayGamma(void *linux_side, VROverlayHandle_t ulOverlayHandle, float *pfGamma)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_SetOverlayWidthInMeters(void *linux_side, VROverlayHandle_t ulOverlayHandle, float fWidthInMeters)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_GetOverlayWidthInMeters(void *linux_side, VROverlayHandle_t ulOverlayHandle, float *pfWidthInMeters)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_SetOverlayTextureBounds(void *linux_side, VROverlayHandle_t ulOverlayHandle, const VRTextureBounds_t *pOverlayTextureBounds)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_GetOverlayTextureBounds(void *linux_side, VROverlayHandle_t ulOverlayHandle, VRTextureBounds_t *pOverlayTextureBounds)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_GetOverlayTransformType(void *linux_side, VROverlayHandle_t ulOverlayHandle, VROverlayTransformType *peTransformType)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_SetOverlayTransformAbsolute(void *linux_side, VROverlayHandle_t ulOverlayHandle, TrackingUniverseOrigin eTrackingOrigin, const HmdMatrix34_t *pmatTrackingOriginToOverlayTransform)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_GetOverlayTransformAbsolute(void *linux_side, VROverlayHandle_t ulOverlayHandle, TrackingUniverseOrigin *peTrackingOrigin, HmdMatrix34_t *pmatTrackingOriginToOverlayTransform)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_SetOverlayTransformTrackedDeviceRelative(void *linux_side, VROverlayHandle_t ulOverlayHandle, TrackedDeviceIndex_t unTrackedDevice, const HmdMatrix34_t *pmatTrackedDeviceToOverlayTransform)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_GetOverlayTransformTrackedDeviceRelative(void *linux_side, VROverlayHandle_t ulOverlayHandle, TrackedDeviceIndex_t *punTrackedDevice, HmdMatrix34_t *pmatTrackedDeviceToOverlayTransform)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_ShowOverlay(void *linux_side, VROverlayHandle_t ulOverlayHandle)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_HideOverlay(void *linux_side, VROverlayHandle_t ulOverlayHandle)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_GetOverlayInputMethod(void *linux_side, VROverlayHandle_t ulOverlayHandle, VROverlayInputMethod *peInputMethod)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_SetOverlayInputMethod(void *linux_side, VROverlayHandle_t ulOverlayHandle, VROverlayInputMethod eInputMethod)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_GetOverlayMouseScale(void *linux_side, VROverlayHandle_t ulOverlayHandle, HmdVector2_t *pvecMouseScale)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_SetOverlayMouseScale(void *linux_side, VROverlayHandle_t ulOverlayHandle, const HmdVector2_t *pvecMouseScale)
{
    VROverlayError _ret;
...
bool cppIVROverlay_IVROverlay_003_ComputeOverlayIntersection(void *linux_side, VROverlayHandle_t ulOverlayHandle, const VROverlayIntersectionParams_t *pParams, VROverlayIntersectionResults_t *pResults)
{
    bool _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_SetOverlayTexture(void *linux_side, VROverlayHandle_t ulOverlayHandle, GraphicsAPIConvention eTextureType, void *pTexture)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_ClearOverlayTexture(void *linux_side, VROverlayHandle_t ulOverlayHandle)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_SetOverlayRaw(void *linux_side, VROverlayHandle_t ulOverlayHandle, void *pvBuffer, uint32_t unWidth, uint32_t unHeight, uint32_t unDepth)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_SetOverlayFromFile(void *linux_side, VROverlayHandle_t ulOverlayHandle, const char *pchFilePath)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_CreateDashboardOverlay(void *linux_side, const char *pchOverlayKey, const char *pchOverlayFriendlyName, VROverlayHandle_t *pMainHandle, VROverlayHandle_t *pThumbnailHandle)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_SetDashboardOverlaySceneProcess(void *linux_side, VROverlayHandle_t ulOverlayHandle, uint32_t unProcessId)
{
    VROverlayError _ret;
...
VROverlayError cppIVROverlay_IVROverlay_003_GetDashboardOverlaySceneProcess(void *linux_side, VROverlayHandle_t ulOverlayHandle, uint32_t *punProcessId)
{
    VROverlayError _ret;
