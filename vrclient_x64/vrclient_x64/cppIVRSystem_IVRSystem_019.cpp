...
HmdMatrix44_t cppIVRSystem_IVRSystem_019_GetProjectionMatrix(void *linux_side, EVREye eEye, float fNearZ, float fFarZ)
{
    HmdMatrix44_t _ret;
...
HmdMatrix34_t cppIVRSystem_IVRSystem_019_GetEyeToHeadTransform(void *linux_side, EVREye eEye)
{
    HmdMatrix34_t _ret;
...
HmdMatrix34_t cppIVRSystem_IVRSystem_019_GetSeatedZeroPoseToStandingAbsoluteTrackingPose(void *linux_side)
{
    HmdMatrix34_t _ret;
...
HmdMatrix34_t cppIVRSystem_IVRSystem_019_GetRawZeroPoseToStandingAbsoluteTrackingPose(void *linux_side)
{
    HmdMatrix34_t _ret;
...
EDeviceActivityLevel cppIVRSystem_IVRSystem_019_GetTrackedDeviceActivityLevel(void *linux_side, TrackedDeviceIndex_t unDeviceId)
{
...
void cppIVRSystem_IVRSystem_019_ApplyTransform(void *linux_side, TrackedDevicePose_t *pOutputPose, const TrackedDevicePose_t *pTrackedDevicePose, const HmdMatrix34_t *pTransform)
{
...
TrackedDeviceIndex_t cppIVRSystem_IVRSystem_019_GetTrackedDeviceIndexForControllerRole(void *linux_side, ETrackedControllerRole unDeviceType)
{
...
ETrackedControllerRole cppIVRSystem_IVRSystem_019_GetControllerRoleForTrackedDeviceIndex(void *linux_side, TrackedDeviceIndex_t unDeviceIndex)
{
...
ETrackedDeviceClass cppIVRSystem_IVRSystem_019_GetTrackedDeviceClass(void *linux_side, TrackedDeviceIndex_t unDeviceIndex)
{
...
HmdMatrix34_t cppIVRSystem_IVRSystem_019_GetMatrix34TrackedDeviceProperty(void *linux_side, TrackedDeviceIndex_t unDeviceIndex, ETrackedDeviceProperty prop, ETrackedPropertyError *pError)
{
    HmdMatrix34_t _ret;
...
bool cppIVRSystem_IVRSystem_019_PollNextEvent(void *linux_side, winVREvent_t_1418 *pEvent, uint32_t uncbVREvent)
{
    ...
    if (pEvent)
        struct_VREvent_t_1418_win_to_lin(pEvent, &lin_pEvent);
    ...
    if (pEvent)
        struct_VREvent_t_1418_lin_to_win(&lin_pEvent, pEvent, uncbVREvent);
    return _ret;
}
...
HiddenAreaMesh_t cppIVRSystem_IVRSystem_019_GetHiddenAreaMesh(void *linux_side, EVREye eEye, EHiddenAreaMeshType type)
{
...
bool cppIVRSystem_IVRSystem_019_GetControllerState(void *linux_side, TrackedDeviceIndex_t unControllerDeviceIndex, winVRControllerState001_t_1418 *pControllerState, uint32_t unControllerStateSize)
{
    ...
    if (pControllerState)
        struct_VRControllerState001_t_1418_win_to_lin(pControllerState, &lin_pControllerState);
...
EVRFirmwareError cppIVRSystem_IVRSystem_019_PerformFirmwareUpdate(void *linux_side, TrackedDeviceIndex_t unDeviceIndex)
{
