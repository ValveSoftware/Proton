...
extern void cppIVRSystem_IVRSystem_021_ApplyTransform(void *, TrackedDevicePose_t *, const TrackedDevicePose_t *, const HmdMatrix34_t *);
...
extern bool cppIVRSystem_IVRSystem_021_PollNextEvent(void *, winVREvent_t_1125 *, uint32_t);
extern bool cppIVRSystem_IVRSystem_021_PollNextEventWithPose(void *, ETrackingUniverseOrigin, winVREvent_t_1125 *, uint32_t, TrackedDevicePose_t *);
...
extern bool cppIVRSystem_IVRSystem_021_GetControllerState(void *, TrackedDeviceIndex_t, winVRControllerState001_t_1125 *, uint32_t);
extern bool cppIVRSystem_IVRSystem_021_GetControllerStateWithPose(void *, ETrackingUniverseOrigin, TrackedDeviceIndex_t, winVRControllerState001_t_1125 *, uint32_t, TrackedDevicePose_t *);
