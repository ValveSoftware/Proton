...
struct cppIVRSystem_IVRSystem_016
{
#ifdef __cplusplus
...
{
    struct cppIVRSystem_IVRSystem_016 *iface = (struct cppIVRSystem_IVRSystem_016 *)params->linux_side;
...
void cppIVRSystem_IVRSystem_016_PollNextEvent( struct cppIVRSystem_IVRSystem_016_PollNextEvent_params *params )
{
    ...
    if (params->pEvent)
        struct_VREvent_t_109_win_to_lin( params->pEvent, &lin_pEvent );
    ...
    if (params->pEvent)
        struct_VREvent_t_109_lin_to_win( &lin_pEvent, params->pEvent, params->uncbVREvent );
}
...
void cppIVRSystem_IVRSystem_016_GetControllerState( struct cppIVRSystem_IVRSystem_016_GetControllerState_params *params )
{
    ...
    if (params->pControllerState)
        struct_VRControllerState001_t_109_win_to_lin( params->pControllerState, &lin_pControllerState );
    ...
    if (params->pControllerState)
        struct_VRControllerState001_t_109_lin_to_win( &lin_pControllerState, params->pControllerState, params->unControllerStateSize );
}
