...
HmdMatrix44_t cppIVRSystem_IVRSystem_016_GetProjectionMatrix(void *linux_side, EVREye eEye, float fNearZ, float fFarZ)
{
    HmdMatrix44_t _ret;
...
HmdMatrix34_t cppIVRSystem_IVRSystem_016_GetEyeToHeadTransform(void *linux_side, EVREye eEye)
{
    HmdMatrix34_t _ret;
...
HmdMatrix34_t cppIVRSystem_IVRSystem_016_GetSeatedZeroPoseToStandingAbsoluteTrackingPose(void *linux_side)
{
    HmdMatrix34_t _ret;
...
HmdMatrix34_t cppIVRSystem_IVRSystem_016_GetRawZeroPoseToStandingAbsoluteTrackingPose(void *linux_side)
{
    HmdMatrix34_t _ret;
...
EDeviceActivityLevel cppIVRSystem_IVRSystem_016_GetTrackedDeviceActivityLevel(void *linux_side, TrackedDeviceIndex_t unDeviceId)
{
...
void cppIVRSystem_IVRSystem_016_ApplyTransform(void *linux_side, TrackedDevicePose_t *pOutputPose, const TrackedDevicePose_t *pTrackedDevicePose, const HmdMatrix34_t *pTransform)
{
...
TrackedDeviceIndex_t cppIVRSystem_IVRSystem_016_GetTrackedDeviceIndexForControllerRole(void *linux_side, ETrackedControllerRole unDeviceType)
{
...
ETrackedControllerRole cppIVRSystem_IVRSystem_016_GetControllerRoleForTrackedDeviceIndex(void *linux_side, TrackedDeviceIndex_t unDeviceIndex)
{
...
ETrackedDeviceClass cppIVRSystem_IVRSystem_016_GetTrackedDeviceClass(void *linux_side, TrackedDeviceIndex_t unDeviceIndex)
{
...
HmdMatrix34_t cppIVRSystem_IVRSystem_016_GetMatrix34TrackedDeviceProperty(void *linux_side, TrackedDeviceIndex_t unDeviceIndex, ETrackedDeviceProperty prop, ETrackedPropertyError *pError)
{
    HmdMatrix34_t _ret;
...
bool cppIVRSystem_IVRSystem_016_PollNextEvent(void *linux_side, winVREvent_t_109 *pEvent, uint32_t uncbVREvent)
{
    ...
    if (pEvent)
        struct_VREvent_t_109_win_to_lin(pEvent, &lin_pEvent);
    ...
    if (pEvent)
        struct_VREvent_t_109_lin_to_win(&lin_pEvent, pEvent, uncbVREvent);
    return _ret;
}
...
HiddenAreaMesh_t cppIVRSystem_IVRSystem_016_GetHiddenAreaMesh(void *linux_side, EVREye eEye, EHiddenAreaMeshType type)
{
...
bool cppIVRSystem_IVRSystem_016_GetControllerState(void *linux_side, TrackedDeviceIndex_t unControllerDeviceIndex, winVRControllerState001_t_109 *pControllerState, uint32_t unControllerStateSize)
{
    ...
    if (pControllerState)
        struct_VRControllerState001_t_109_win_to_lin(pControllerState, &lin_pControllerState);
...
EVRFirmwareError cppIVRSystem_IVRSystem_016_PerformFirmwareUpdate(void *linux_side, TrackedDeviceIndex_t unDeviceIndex)
{
