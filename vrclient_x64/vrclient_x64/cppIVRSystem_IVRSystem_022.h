...
extern void cppIVRSystem_IVRSystem_022_ApplyTransform(void *, TrackedDevicePose_t *, const TrackedDevicePose_t *, const HmdMatrix34_t *);
...
extern bool cppIVRSystem_IVRSystem_022_PollNextEvent(void *, winVREvent_t_1267 *, uint32_t);
extern bool cppIVRSystem_IVRSystem_022_PollNextEventWithPose(void *, ETrackingUniverseOrigin, winVREvent_t_1267 *, uint32_t, TrackedDevicePose_t *);
...
extern bool cppIVRSystem_IVRSystem_022_GetControllerState(void *, TrackedDeviceIndex_t, winVRControllerState001_t_1267 *, uint32_t);
extern bool cppIVRSystem_IVRSystem_022_GetControllerStateWithPose(void *, ETrackingUniverseOrigin, TrackedDeviceIndex_t, winVRControllerState001_t_1267 *, uint32_t, TrackedDevicePose_t *);
