...
extern EVROverlayError cppIVROverlay_IVROverlay_026_SetOverlayTextureBounds(void *, VROverlayHandle_t, const VRTextureBounds_t *);
...
extern EVROverlayError cppIVROverlay_IVROverlay_026_SetOverlayTransformAbsolute(void *, VROverlayHandle_t, ETrackingUniverseOrigin, const HmdMatrix34_t *);
...
extern EVROverlayError cppIVROverlay_IVROverlay_026_SetOverlayTransformTrackedDeviceRelative(void *, VROverlayHandle_t, TrackedDeviceIndex_t, const HmdMatrix34_t *);
...
extern EVROverlayError cppIVROverlay_IVROverlay_026_SetOverlayTransformOverlayRelative(void *, VROverlayHandle_t, VROverlayHandle_t, const HmdMatrix34_t *);
extern EVROverlayError cppIVROverlay_IVROverlay_026_SetOverlayTransformCursor(void *, VROverlayHandle_t, const HmdVector2_t *);
extern EVROverlayError cppIVROverlay_IVROverlay_026_GetOverlayTransformCursor(void *, VROverlayHandle_t, HmdVector2_t *);
extern EVROverlayError cppIVROverlay_IVROverlay_026_SetOverlayTransformProjection(void *, VROverlayHandle_t, ETrackingUniverseOrigin, const HmdMatrix34_t *, const VROverlayProjection_t *, EVREye);
...
extern EVROverlayError cppIVROverlay_IVROverlay_026_SetOverlayMouseScale(void *, VROverlayHandle_t, const HmdVector2_t *);
extern bool cppIVROverlay_IVROverlay_026_ComputeOverlayIntersection(void *, VROverlayHandle_t, const VROverlayIntersectionParams_t *, VROverlayIntersectionResults_t *);
...
extern EVROverlayError cppIVROverlay_IVROverlay_026_SetOverlayCursorPositionOverride(void *, VROverlayHandle_t, const HmdVector2_t *);
extern EVROverlayError cppIVROverlay_IVROverlay_026_ClearOverlayCursorPositionOverride(void *, VROverlayHandle_t);
extern EVROverlayError cppIVROverlay_IVROverlay_026_SetOverlayTexture(void *, VROverlayHandle_t, const Texture_t *);
...
extern void cppIVROverlay_IVROverlay_026_SetKeyboardTransformAbsolute(void *, ETrackingUniverseOrigin, const HmdMatrix34_t *);
