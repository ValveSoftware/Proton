...
extern "C" {
#endif
extern EVRRenderModelError cppIVRRenderModels_IVRRenderModels_006_LoadRenderModel_Async(void *, const char *, winRenderModel_t_1267 **);
extern void cppIVRRenderModels_IVRRenderModels_006_FreeRenderModel(void *, winRenderModel_t_1267 *);
extern EVRRenderModelError cppIVRRenderModels_IVRRenderModels_006_LoadTexture_Async(void *, TextureID_t, winRenderModel_TextureMap_t_1267 **);
extern void cppIVRRenderModels_IVRRenderModels_006_FreeTexture(void *, winRenderModel_TextureMap_t_1267 *);
...
extern bool cppIVRRenderModels_IVRRenderModels_006_GetComponentStateForDevicePath(void *, const char *, const char *, VRInputValueHandle_t, const RenderModel_ControllerMode_State_t *, RenderModel_ComponentState_t *);
extern bool cppIVRRenderModels_IVRRenderModels_006_GetComponentState(void *, const char *, const char *, const VRControllerState_t *, const RenderModel_ControllerMode_State_t *, RenderModel_ComponentState_t *);
