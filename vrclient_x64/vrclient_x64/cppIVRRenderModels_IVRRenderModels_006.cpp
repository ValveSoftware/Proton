...
extern "C" {
#endif
vr::EVRRenderModelError cppIVRRenderModels_IVRRenderModels_006_LoadRenderModel_Async(void *linux_side, const char * pchRenderModelName, winRenderModel_t_1237 ** ppRenderModel)
{
    RenderModel_t *lin;
    ...
    if(_ret == 0)
        *ppRenderModel = struct_RenderModel_t_1237_wrap(lin);
    return _ret;
}

void cppIVRRenderModels_IVRRenderModels_006_FreeRenderModel(void *linux_side, winRenderModel_t_1237 * pRenderModel)
{
    ((IVRRenderModels*)linux_side)->FreeRenderModel(struct_RenderModel_t_1237_unwrap(pRenderModel));
}

vr::EVRRenderModelError cppIVRRenderModels_IVRRenderModels_006_LoadTexture_Async(void *linux_side, TextureID_t textureId, winRenderModel_TextureMap_t_1237 ** ppTexture)
{
    ...
    if(_ret == 0)
        *ppTexture = struct_RenderModel_TextureMap_t_1237_wrap(lin);
    return _ret;
}

void cppIVRRenderModels_IVRRenderModels_006_FreeTexture(void *linux_side, winRenderModel_TextureMap_t_1237 * pTexture)
{
    ((IVRRenderModels*)linux_side)->FreeTexture(struct_RenderModel_TextureMap_t_1237_unwrap(pTexture));
}
