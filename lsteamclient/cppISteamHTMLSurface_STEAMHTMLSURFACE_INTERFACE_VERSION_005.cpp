...
{
#ifdef __cplusplus
    virtual ~cppISteamHTMLSurface_STEAMHTMLSURFACE_INTERFACE_VERSION_005(  ) = 0;
    virtual bool Init(  ) = 0;
...
{
    struct cppISteamHTMLSurface_STEAMHTMLSURFACE_INTERFACE_VERSION_005 *iface = (struct cppISteamHTMLSurface_STEAMHTMLSURFACE_INTERFACE_VERSION_005 *)params->linux_side;
...
void cppISteamHTMLSurface_STEAMHTMLSURFACE_INTERFACE_VERSION_005_KeyDown( struct cppISteamHTMLSurface_STEAMHTMLSURFACE_INTERFACE_VERSION_005_KeyDown_params *params )
{
    ...
    iface->KeyDown( params->unBrowserHandle, lin_nNativeKeyCode, params->eHTMLKeyModifiers, params->bIsSystemKey );
}
