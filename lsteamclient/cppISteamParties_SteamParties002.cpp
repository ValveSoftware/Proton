...
bool cppISteamParties_SteamParties002_GetBeaconDetails(void *linux_side, PartyBeaconID_t ulBeaconID, CSteamID * pSteamIDBeaconOwner, winSteamPartyBeaconLocation_t_143 * pLocation, char * pchMetadata, int cchMetadata)
{
    SteamPartyBeaconLocation_t lin_pLocation;
    win_to_lin_struct_SteamPartyBeaconLocation_t_143(pLocation, &lin_pLocation);
    ...
    lin_to_win_struct_SteamPartyBeaconLocation_t_143(&lin_pLocation, pLocation);
    return retval;
}
...
bool cppISteamParties_SteamParties002_GetAvailableBeaconLocations(void *linux_side, winSteamPartyBeaconLocation_t_143 * pLocationList, uint32 uMaxNumLocations)
{
    SteamPartyBeaconLocation_t lin_pLocationList;
    win_to_lin_struct_SteamPartyBeaconLocation_t_143(pLocationList, &lin_pLocationList);
    bool retval = ((ISteamParties*)linux_side)->GetAvailableBeaconLocations(&lin_pLocationList, (uint32)uMaxNumLocations);
    lin_to_win_struct_SteamPartyBeaconLocation_t_143(&lin_pLocationList, pLocationList);
    return retval;
}

SteamAPICall_t cppISteamParties_SteamParties002_CreateBeacon(void *linux_side, uint32 unOpenSlots, winSteamPartyBeaconLocation_t_143 * pBeaconLocation, const char * pchConnectString, const char * pchMetadata)
{
    SteamPartyBeaconLocation_t lin_pBeaconLocation;
    win_to_lin_struct_SteamPartyBeaconLocation_t_143(pBeaconLocation, &lin_pBeaconLocation);
    ...
    lin_to_win_struct_SteamPartyBeaconLocation_t_143(&lin_pBeaconLocation, pBeaconLocation);
    return retval;
}
...
bool cppISteamParties_SteamParties002_GetBeaconLocationData(void *linux_side, winSteamPartyBeaconLocation_t_143 BeaconLocation, ESteamPartyBeaconLocationData eData, char * pchDataStringOut, int cchDataStringOut)
{
    SteamPartyBeaconLocation_t lin_BeaconLocation;
    win_to_lin_struct_SteamPartyBeaconLocation_t_143(&BeaconLocation, &lin_BeaconLocation);
    ...
    lin_to_win_struct_SteamPartyBeaconLocation_t_143(&lin_BeaconLocation, &BeaconLocation);
    return retval;
}
