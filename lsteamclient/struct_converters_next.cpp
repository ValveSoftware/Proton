...
#pragma pack( pop )
void win_to_lin_struct_SteamPartyBeaconLocation_t_next(const void *w, void *l)
{
    SteamPartyBeaconLocation_t *lin = (SteamPartyBeaconLocation_t *)l;
    struct winSteamPartyBeaconLocation_t_next *win = (struct winSteamPartyBeaconLocation_t_next *)w;
    lin->m_eType = win->m_eType;
    lin->m_ulLocationID = win->m_ulLocationID;
}

void lin_to_win_struct_SteamPartyBeaconLocation_t_next(const void *l, void *w)
{
    SteamPartyBeaconLocation_t *lin = (SteamPartyBeaconLocation_t *)l;
    struct winSteamPartyBeaconLocation_t_next *win = (struct winSteamPartyBeaconLocation_t_next *)w;
...
#pragma pack( pop )
void win_to_lin_struct_LeaderboardEntry_t_next(const void *w, void *l)
{
    LeaderboardEntry_t *lin = (LeaderboardEntry_t *)l;
    struct winLeaderboardEntry_t_next *win = (struct winLeaderboardEntry_t_next *)w;
...
void lin_to_win_struct_LeaderboardEntry_t_next(const void *l, void *w)
{
    LeaderboardEntry_t *lin = (LeaderboardEntry_t *)l;
    struct winLeaderboardEntry_t_next *win = (struct winLeaderboardEntry_t_next *)w;
...
#pragma pack( pop )
void win_to_lin_struct_SteamUGCDetails_t_next(const void *w, void *l)
{
    SteamUGCDetails_t *lin = (SteamUGCDetails_t *)l;
    struct winSteamUGCDetails_t_next *win = (struct winSteamUGCDetails_t_next *)w;
...
void lin_to_win_struct_SteamUGCDetails_t_next(const void *l, void *w)
{
    SteamUGCDetails_t *lin = (SteamUGCDetails_t *)l;
    struct winSteamUGCDetails_t_next *win = (struct winSteamUGCDetails_t_next *)w;
