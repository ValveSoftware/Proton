...
#pragma pack( pop )
void win_to_lin_struct_LeaderboardEntry_t_137(const void *w, void *l)
{
...
void lin_to_win_struct_LeaderboardEntry_t_137(const void *l, void *w)
{
    LeaderboardEntry_t *lin = (LeaderboardEntry_t *)l;
    struct winLeaderboardEntry_t_137 *win = (struct winLeaderboardEntry_t_137 *)w;
...
#pragma pack( pop )
void win_to_lin_struct_SteamUGCDetails_t_137(const void *w, void *l)
{
...
void lin_to_win_struct_SteamUGCDetails_t_137(const void *l, void *w)
{
    SteamUGCDetails_t *lin = (SteamUGCDetails_t *)l;
    struct winSteamUGCDetails_t_137 *win = (struct winSteamUGCDetails_t_137 *)w;
