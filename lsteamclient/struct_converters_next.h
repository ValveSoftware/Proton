extern void win_to_lin_struct_SteamPartyBeaconLocation_t_next(const void *w, void *l);
extern void lin_to_win_struct_SteamPartyBeaconLocation_t_next(const void *l, void *w);
