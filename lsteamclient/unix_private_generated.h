...
struct u_ISteamFriends_SteamFriends018
{
#ifdef __cplusplus
    virtual const char * GetPersonaName(  ) = 0;
    virtual uint32_t GetPersonaState(  ) = 0;
...
struct u_ISteamUGC_STEAMUGC_INTERFACE_VERSION021
{
#ifdef __cplusplus
    virtual uint64_t CreateQueryUserUGCRequest( uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t, uint32_t ) = 0;
    virtual uint64_t CreateQueryAllUGCRequest( uint32_t, uint32_t, uint32_t, uint32_t, uint32_t ) = 0;
    ...
    virtual uint64_t SubscribeItem( uint64_t ) = 0;
    virtual uint64_t UnsubscribeItem( uint64_t ) = 0;
    virtual uint32_t GetNumSubscribedItems( int8_t ) = 0;
    virtual uint32_t GetSubscribedItems( uint64_t *, uint32_t, int8_t ) = 0;
    virtual uint32_t GetItemState( uint64_t ) = 0;
    virtual int8_t GetItemInstallInfo( uint64_t, uint64_t *, char *, uint32_t, uint32_t * ) = 0;
    virtual int8_t GetItemDownloadInfo( uint64_t, uint64_t *, uint64_t * ) = 0;
    virtual int8_t DownloadItem( uint64_t, int8_t ) = 0;
    ...
    virtual uint64_t GetWorkshopEULAStatus(  ) = 0;
    virtual uint32_t GetUserContentDescriptorPreferences( uint32_t *, uint32_t ) = 0;
    virtual int8_t SetItemsDisabledLocally( uint64_t *, uint32_t, int8_t ) = 0;
    virtual int8_t SetSubscriptionsLoadOrder( uint64_t *, uint32_t ) = 0;
#endif /* __cplusplus */
};

struct u_ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003
{
#ifdef __cplusplus
    virtual uint32_t GetSessionCount(  ) = 0;
    virtual uint32_t GetSessionID( int32_t ) = 0;
    ...
    virtual uint32_t GetSessionClientFormFactor( uint32_t ) = 0;
    virtual int8_t BGetSessionClientResolution( uint32_t, int32_t *, int32_t * ) = 0;
    virtual int8_t ShowRemotePlayTogetherUI(  ) = 0;
    virtual int8_t BSendRemotePlayTogetherInvite( CSteamID ) = 0;
    virtual int8_t BEnableRemotePlayTogetherDirectInput(  ) = 0;
    virtual void DisableRemotePlayTogetherDirectInput(  ) = 0;
    virtual uint32_t GetInput( RemotePlayInput_t *, uint32_t ) = 0;
    virtual void SetMouseVisibility( uint32_t, int8_t ) = 0;
    virtual void SetMousePosition( uint32_t, float, float ) = 0;
    virtual uint32_t CreateMouseCursor( int32_t, int32_t, int32_t, int32_t, const void *, int32_t ) = 0;
    virtual void SetMouseCursor( uint32_t, uint32_t ) = 0;
#endif /* __cplusplus */
};
...
NTSTATUS ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003_GetSessionCount( void * );
NTSTATUS ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003_GetSessionID( void * );
NTSTATUS ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003_GetSessionSteamID( void * );
NTSTATUS ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003_GetSessionClientName( void * );
NTSTATUS ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003_GetSessionClientFormFactor( void * );
NTSTATUS ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003_BGetSessionClientResolution( void * );
NTSTATUS ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003_ShowRemotePlayTogetherUI( void * );
NTSTATUS ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003_BSendRemotePlayTogetherInvite( void * );
NTSTATUS ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003_BEnableRemotePlayTogetherDirectInput( void * );
NTSTATUS ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003_DisableRemotePlayTogetherDirectInput( void * );
NTSTATUS ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003_GetInput( void * );
NTSTATUS ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003_SetMouseVisibility( void * );
NTSTATUS ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003_SetMousePosition( void * );
NTSTATUS ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003_CreateMouseCursor( void * );
NTSTATUS ISteamRemotePlay_STEAMREMOTEPLAY_INTERFACE_VERSION003_SetMouseCursor( void * );
...
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_CreateQueryUserUGCRequest( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_CreateQueryAllUGCRequest( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_CreateQueryAllUGCRequest_2( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_CreateQueryUGCDetailsRequest( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SendQueryUGCRequest( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetQueryUGCResult( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetQueryUGCNumTags( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetQueryUGCTag( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetQueryUGCTagDisplayName( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetQueryUGCPreviewURL( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetQueryUGCMetadata( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetQueryUGCChildren( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetQueryUGCStatistic( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetQueryUGCNumAdditionalPreviews( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetQueryUGCAdditionalPreview( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetQueryUGCNumKeyValueTags( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetQueryUGCKeyValueTag( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetQueryUGCKeyValueTag_2( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetNumSupportedGameVersions( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetSupportedGameVersionData( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetQueryUGCContentDescriptors( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_ReleaseQueryUGCRequest( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_AddRequiredTag( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_AddRequiredTagGroup( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_AddExcludedTag( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetReturnOnlyIDs( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetReturnKeyValueTags( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetReturnLongDescription( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetReturnMetadata( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetReturnChildren( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetReturnAdditionalPreviews( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetReturnTotalOnly( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetReturnPlaytimeStats( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetLanguage( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetAllowCachedResponse( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetAdminQuery( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetCloudFileNameFilter( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetMatchAnyTag( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetSearchText( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetRankedByTrendDays( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetTimeCreatedDateRange( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetTimeUpdatedDateRange( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_AddRequiredKeyValueTag( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_RequestUGCDetails( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_CreateItem( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_StartItemUpdate( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetItemTitle( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetItemDescription( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetItemUpdateLanguage( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetItemMetadata( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetItemVisibility( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetItemTags( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetItemContent( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetItemPreview( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetAllowLegacyUpload( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_RemoveAllItemKeyValueTags( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_RemoveItemKeyValueTags( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_AddItemKeyValueTag( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_AddItemPreviewFile( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_AddItemPreviewVideo( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_UpdateItemPreviewFile( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_UpdateItemPreviewVideo( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_RemoveItemPreview( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_AddContentDescriptor( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_RemoveContentDescriptor( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetRequiredGameVersions( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SubmitItemUpdate( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetItemUpdateProgress( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetUserItemVote( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetUserItemVote( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_AddItemToFavorites( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_RemoveItemFromFavorites( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SubscribeItem( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_UnsubscribeItem( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetNumSubscribedItems( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetSubscribedItems( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetItemState( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetItemInstallInfo( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetItemDownloadInfo( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_DownloadItem( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_BInitWorkshopForGameServer( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SuspendDownloads( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_StartPlaytimeTracking( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_StopPlaytimeTracking( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_StopPlaytimeTrackingForAllItems( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_AddDependency( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_RemoveDependency( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_AddAppDependency( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_RemoveAppDependency( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetAppDependencies( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_DeleteItem( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_ShowWorkshopEULA( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetWorkshopEULAStatus( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_GetUserContentDescriptorPreferences( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetItemsDisabledLocally( void * );
NTSTATUS ISteamUGC_STEAMUGC_INTERFACE_VERSION021_SetSubscriptionsLoadOrder( void * );
...
NTSTATUS ISteamFriends_SteamFriends018_GetPersonaName( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetPersonaState( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendCount( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendByIndex( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendRelationship( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendPersonaState( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendPersonaName( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendGamePlayed( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendPersonaNameHistory( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendSteamLevel( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetPlayerNickname( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendsGroupCount( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendsGroupIDByIndex( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendsGroupName( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendsGroupMembersCount( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendsGroupMembersList( void * );
NTSTATUS ISteamFriends_SteamFriends018_HasFriend( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetClanCount( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetClanByIndex( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetClanName( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetClanTag( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetClanActivityCounts( void * );
NTSTATUS ISteamFriends_SteamFriends018_DownloadClanActivityCounts( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendCountFromSource( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendFromSourceByIndex( void * );
NTSTATUS ISteamFriends_SteamFriends018_IsUserInSource( void * );
NTSTATUS ISteamFriends_SteamFriends018_SetInGameVoiceSpeaking( void * );
NTSTATUS ISteamFriends_SteamFriends018_ActivateGameOverlay( void * );
NTSTATUS ISteamFriends_SteamFriends018_ActivateGameOverlayToUser( void * );
NTSTATUS ISteamFriends_SteamFriends018_ActivateGameOverlayToWebPage( void * );
NTSTATUS ISteamFriends_SteamFriends018_ActivateGameOverlayToStore( void * );
NTSTATUS ISteamFriends_SteamFriends018_SetPlayedWith( void * );
NTSTATUS ISteamFriends_SteamFriends018_ActivateGameOverlayInviteDialog( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetSmallFriendAvatar( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetMediumFriendAvatar( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetLargeFriendAvatar( void * );
NTSTATUS ISteamFriends_SteamFriends018_RequestUserInformation( void * );
NTSTATUS ISteamFriends_SteamFriends018_RequestClanOfficerList( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetClanOwner( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetClanOfficerCount( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetClanOfficerByIndex( void * );
NTSTATUS ISteamFriends_SteamFriends018_SetRichPresence( void * );
NTSTATUS ISteamFriends_SteamFriends018_ClearRichPresence( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendRichPresence( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendRichPresenceKeyCount( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendRichPresenceKeyByIndex( void * );
NTSTATUS ISteamFriends_SteamFriends018_RequestFriendRichPresence( void * );
NTSTATUS ISteamFriends_SteamFriends018_InviteUserToGame( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetCoplayFriendCount( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetCoplayFriend( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendCoplayTime( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendCoplayGame( void * );
NTSTATUS ISteamFriends_SteamFriends018_JoinClanChatRoom( void * );
NTSTATUS ISteamFriends_SteamFriends018_LeaveClanChatRoom( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetClanChatMemberCount( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetChatMemberByIndex( void * );
NTSTATUS ISteamFriends_SteamFriends018_SendClanChatMessage( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetClanChatMessage( void * );
NTSTATUS ISteamFriends_SteamFriends018_IsClanChatAdmin( void * );
NTSTATUS ISteamFriends_SteamFriends018_IsClanChatWindowOpenInSteam( void * );
NTSTATUS ISteamFriends_SteamFriends018_OpenClanChatWindowInSteam( void * );
NTSTATUS ISteamFriends_SteamFriends018_CloseClanChatWindowInSteam( void * );
NTSTATUS ISteamFriends_SteamFriends018_SetListenForFriendsMessages( void * );
NTSTATUS ISteamFriends_SteamFriends018_ReplyToFriendMessage( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFriendMessage( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetFollowerCount( void * );
NTSTATUS ISteamFriends_SteamFriends018_IsFollowing( void * );
NTSTATUS ISteamFriends_SteamFriends018_EnumerateFollowingList( void * );
NTSTATUS ISteamFriends_SteamFriends018_IsClanPublic( void * );
NTSTATUS ISteamFriends_SteamFriends018_IsClanOfficialGameGroup( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetNumChatsWithUnreadPriorityMessages( void * );
NTSTATUS ISteamFriends_SteamFriends018_ActivateGameOverlayRemotePlayTogetherInviteDialog( void * );
NTSTATUS ISteamFriends_SteamFriends018_RegisterProtocolInOverlayBrowser( void * );
NTSTATUS ISteamFriends_SteamFriends018_ActivateGameOverlayInviteDialogConnectString( void * );
NTSTATUS ISteamFriends_SteamFriends018_RequestEquippedProfileItems( void * );
NTSTATUS ISteamFriends_SteamFriends018_BHasEquippedProfileItem( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetProfileItemPropertyString( void * );
NTSTATUS ISteamFriends_SteamFriends018_GetProfileItemPropertyUint( void * );
