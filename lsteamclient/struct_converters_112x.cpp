...
#pragma pack( pop )
void win_to_lin_struct_LeaderboardEntry_t_112x(const void *w, void *l)
{
    LeaderboardEntry_t *lin = (LeaderboardEntry_t *)l;
    struct winLeaderboardEntry_t_112x *win = (struct winLeaderboardEntry_t_112x *)w;
...
void lin_to_win_struct_LeaderboardEntry_t_112x(const void *l, void *w)
{
    LeaderboardEntry_t *lin = (LeaderboardEntry_t *)l;
    struct winLeaderboardEntry_t_112x *win = (struct winLeaderboardEntry_t_112x *)w;
