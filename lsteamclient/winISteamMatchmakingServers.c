...
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_RequestInternetServerList, 20)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_RequestLANServerList, 12)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_RequestFriendsServerList, 20)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_RequestFavoritesServerList, 20)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_RequestHistoryServerList, 20)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_RequestSpectatorServerList, 20)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_ReleaseRequest, 8)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_GetServerDetails, 12)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_CancelQuery, 8)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_RefreshQuery, 8)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_IsRefreshing, 8)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_GetServerCount, 8)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_RefreshServer, 12)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_PingServer, 16)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_PlayerDetails, 16)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_ServerRules, 16)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_ServerFriends, 16)
DEFINE_THISCALL_WRAPPER(winISteamMatchmakingServers_SteamMatchMakingServers003_CancelServerQuery, 8)

void __thiscall winISteamMatchmakingServers_SteamMatchMakingServers003_RefreshQuery(struct w_iface *_this, void *hRequest)
{
    struct ISteamMatchmakingServers_SteamMatchMakingServers003_RefreshQuery_params params =
    {
        .u_iface = _this->u_iface,
        .hRequest = hRequest,
    };
...
int8_t __thiscall winISteamMatchmakingServers_SteamMatchMakingServers003_IsRefreshing(struct w_iface *_this, void *hRequest)
{
    struct ISteamMatchmakingServers_SteamMatchMakingServers003_IsRefreshing_params params =
    {
        .u_iface = _this->u_iface,
        .hRequest = hRequest,
    };
    TRACE("%p\n", _this);
    STEAMCLIENT_CALL( ISteamMatchmakingServers_SteamMatchMakingServers003_IsRefreshing, &params );
    return params._ret;
}

int32_t __thiscall winISteamMatchmakingServers_SteamMatchMakingServers003_GetServerCount(struct w_iface *_this, void *hRequest)
{
    struct ISteamMatchmakingServers_SteamMatchMakingServers003_GetServerCount_params params =
    {
        .u_iface = _this->u_iface,
        .hRequest = hRequest,
    };
    TRACE("%p\n", _this);
    STEAMCLIENT_CALL( ISteamMatchmakingServers_SteamMatchMakingServers003_GetServerCount, &params );
    return params._ret;
}

void __thiscall winISteamMatchmakingServers_SteamMatchMakingServers003_RefreshServer(struct w_iface *_this, void *hRequest, int32_t iServer)
{
    struct ISteamMatchmakingServers_SteamMatchMakingServers003_RefreshServer_params params =
    {
        .u_iface = _this->u_iface,
        .hRequest = hRequest,
        .iServer = iServer,
    ...
    TRACE("%p\n", _this);
    STEAMCLIENT_CALL( ISteamMatchmakingServers_SteamMatchMakingServers003_RefreshServer, &params );
}

int32_t __thiscall winISteamMatchmakingServers_SteamMatchMakingServers003_PingServer(struct w_iface *_this, uint32_t unIP, uint16_t usPort, w_ISteamMatchmakingPingResponse *pRequestServersResponse)
{
    struct ISteamMatchmakingServers_SteamMatchMakingServers003_PingServer_params params =
    {
        .u_iface = _this->u_iface,
        .unIP = unIP,
        .usPort = usPort,
    ...
    TRACE("%p\n", _this);
    STEAMCLIENT_CALL( ISteamMatchmakingServers_SteamMatchMakingServers003_PingServer, &params );
    return params._ret;
}

int32_t __thiscall winISteamMatchmakingServers_SteamMatchMakingServers003_PlayerDetails(struct w_iface *_this, uint32_t unIP, uint16_t usPort, w_ISteamMatchmakingPlayersResponse *pRequestServersResponse)
{
    struct ISteamMatchmakingServers_SteamMatchMakingServers003_PlayerDetails_params params =
    {
        .u_iface = _this->u_iface,
        .unIP = unIP,
        .usPort = usPort,
    ...
    TRACE("%p\n", _this);
    STEAMCLIENT_CALL( ISteamMatchmakingServers_SteamMatchMakingServers003_PlayerDetails, &params );
    return params._ret;
}

int32_t __thiscall winISteamMatchmakingServers_SteamMatchMakingServers003_ServerRules(struct w_iface *_this, uint32_t unIP, uint16_t usPort, w_ISteamMatchmakingRulesResponse *pRequestServersResponse)
{
    struct ISteamMatchmakingServers_SteamMatchMakingServers003_ServerRules_params params =
    {
        .u_iface = _this->u_iface,
        .unIP = unIP,
        .usPort = usPort,
    ...
    TRACE("%p\n", _this);
    STEAMCLIENT_CALL( ISteamMatchmakingServers_SteamMatchMakingServers003_ServerRules, &params );
    return params._ret;
}

int32_t __thiscall winISteamMatchmakingServers_SteamMatchMakingServers003_ServerFriends(struct w_iface *_this, uint32_t unIP, uint16_t usPort, w_ISteamMatchmakingServerFriendsResponse *pRequestServersResponse)
{
    struct ISteamMatchmakingServers_SteamMatchMakingServers003_ServerFriends_params params =
    {
        .u_iface = _this->u_iface,
        .unIP = unIP,
        .usPort = usPort,
    ...
    TRACE("%p\n", _this);
    STEAMCLIENT_CALL( ISteamMatchmakingServers_SteamMatchMakingServers003_ServerFriends, &params );
    return params._ret;
}

void __thiscall winISteamMatchmakingServers_SteamMatchMakingServers003_CancelServerQuery(struct w_iface *_this, int32_t hServerQuery)
{
    struct ISteamMatchmakingServers_SteamMatchMakingServers003_CancelServerQuery_params params =
    {
        .u_iface = _this->u_iface,
        .hServerQuery = hServerQuery,
    };
    TRACE("%p\n", _this);
    STEAMCLIENT_CALL( ISteamMatchmakingServers_SteamMatchMakingServers003_CancelServerQuery, &params );
}

extern vtable_ptr winISteamMatchmakingServers_SteamMatchMakingServers003_vtable;

DEFINE_RTTI_DATA0(winISteamMatchmakingServers_SteamMatchMakingServers003, 0, ".?AVISteamMatchmakingServers@@")

__ASM_BLOCK_BEGIN(winISteamMatchmakingServers_SteamMatchMakingServers003_vtables)
    __ASM_VTABLE(winISteamMatchmakingServers_SteamMatchMakingServers003,
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_RequestInternetServerList)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_RequestLANServerList)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_RequestFriendsServerList)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_RequestFavoritesServerList)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_RequestHistoryServerList)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_RequestSpectatorServerList)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_ReleaseRequest)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_GetServerDetails)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_CancelQuery)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_RefreshQuery)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_IsRefreshing)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_GetServerCount)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_RefreshServer)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_PingServer)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_PlayerDetails)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_ServerRules)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_ServerFriends)
        VTABLE_ADD_FUNC(winISteamMatchmakingServers_SteamMatchMakingServers003_CancelServerQuery)
    );
__ASM_BLOCK_END

struct w_iface *create_winISteamMatchmakingServers_SteamMatchMakingServers003( struct u_iface u_iface )
{
    struct w_iface *r = alloc_mem_for_iface(sizeof(struct w_iface), "SteamMatchMakingServers003");
    TRACE("-> %p\n", r);
    r->vtable = alloc_vtable(&winISteamMatchmakingServers_SteamMatchMakingServers003_vtable, 18, "SteamMatchMakingServers003");
    r->u_iface = u_iface;
    return r;
}
...
void init_winISteamMatchmakingServers_rtti( char *base )
{
    ...
    init_winISteamMatchmakingServers_SteamMatchMakingServers003_rtti( base );
