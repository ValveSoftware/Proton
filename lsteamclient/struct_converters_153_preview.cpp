...
void win_to_lin_struct_SteamPartyBeaconLocation_t_153_preview(const struct winSteamPartyBeaconLocation_t_153_preview *win, struct SteamPartyBeaconLocation_t *lin)
{
    lin->m_eType = win->m_eType;
    lin->m_ulLocationID = win->m_ulLocationID;
}

void lin_to_win_struct_SteamPartyBeaconLocation_t_153_preview(const struct SteamPartyBeaconLocation_t *lin, struct winSteamPartyBeaconLocation_t_153_preview *win)
{
...
void win_to_lin_struct_LeaderboardEntry_t_153_preview(const struct winLeaderboardEntry_t_153_preview *win, struct LeaderboardEntry_t *lin)
{
...
void lin_to_win_struct_LeaderboardEntry_t_153_preview(const struct LeaderboardEntry_t *lin, struct winLeaderboardEntry_t_153_preview *win)
{
...
void win_to_lin_struct_SteamUGCDetails_t_153_preview(const struct winSteamUGCDetails_t_153_preview *win, struct SteamUGCDetails_t *lin)
{
...
void lin_to_win_struct_SteamUGCDetails_t_153_preview(const struct SteamUGCDetails_t *lin, struct winSteamUGCDetails_t_153_preview *win)
{
    win->m_nPublishedFileId = lin->m_nPublishedFileId;
    win->m_eResult = lin->m_eResult;
    win->m_eFileType = lin->m_eFileType;
...
struct winSteamUGCRequestUGCDetailsResult_t_9784 {
    winSteamUGCDetails_t_153_preview m_details;
    bool m_bCachedData;
}  __attribute__ ((ms_struct));
#pragma pack( pop )
...
{
    lin_to_win_struct_SteamUGCDetails_t_153_preview(&lin->m_details, &win->m_details);
