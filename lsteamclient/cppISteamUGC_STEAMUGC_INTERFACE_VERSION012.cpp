...
{
    struct cppISteamUGC_STEAMUGC_INTERFACE_VERSION012 *iface = (struct cppISteamUGC_STEAMUGC_INTERFACE_VERSION012 *)params->linux_side;
...
void cppISteamUGC_STEAMUGC_INTERFACE_VERSION012_GetQueryUGCResult( struct cppISteamUGC_STEAMUGC_INTERFACE_VERSION012_GetQueryUGCResult_params *params )
{
    ...
    win_to_lin_struct_SteamUGCDetails_t_144( params->pDetails, &lin_pDetails );
    params->_ret = iface->GetQueryUGCResult( params->handle, params->index, &lin_pDetails );
    lin_to_win_struct_SteamUGCDetails_t_144( &lin_pDetails, params->pDetails );
}
