...
{
    struct cppISteamScreenshots_STEAMSCREENSHOTS_INTERFACE_VERSION001 *iface = (struct cppISteamScreenshots_STEAMSCREENSHOTS_INTERFACE_VERSION001 *)params->linux_side;
