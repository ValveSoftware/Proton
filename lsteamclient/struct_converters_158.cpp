...
void win_to_lin_struct_SteamPartyBeaconLocation_t_158(const struct winSteamPartyBeaconLocation_t_158 *win, struct SteamPartyBeaconLocation_t *lin)
{
    lin->m_eType = win->m_eType;
    lin->m_ulLocationID = win->m_ulLocationID;
}

void lin_to_win_struct_SteamPartyBeaconLocation_t_158(const struct SteamPartyBeaconLocation_t *lin, struct winSteamPartyBeaconLocation_t_158 *win)
{
...
void win_to_lin_struct_LeaderboardEntry_t_158(const struct winLeaderboardEntry_t_158 *win, struct LeaderboardEntry_t *lin)
{
...
void lin_to_win_struct_LeaderboardEntry_t_158(const struct LeaderboardEntry_t *lin, struct winLeaderboardEntry_t_158 *win)
{
...
#pragma pack( pop )
void cb_SteamInputGamepadSlotChange_t_32(const struct SteamInputGamepadSlotChange_t *lin, struct winSteamInputGamepadSlotChange_t_32 *win)
{
    win->m_unAppID = lin->m_unAppID;
    win->m_ulDeviceHandle = lin->m_ulDeviceHandle;
    win->m_eDeviceType = lin->m_eDeviceType;
    win->m_nOldGamepadSlot = lin->m_nOldGamepadSlot;
    win->m_nNewGamepadSlot = lin->m_nNewGamepadSlot;
}

void win_to_lin_struct_SteamUGCDetails_t_158(const struct winSteamUGCDetails_t_158 *win, struct SteamUGCDetails_t *lin)
{
...
void lin_to_win_struct_SteamUGCDetails_t_158(const struct SteamUGCDetails_t *lin, struct winSteamUGCDetails_t_158 *win)
{
    win->m_nPublishedFileId = lin->m_nPublishedFileId;
    win->m_eResult = lin->m_eResult;
    win->m_eFileType = lin->m_eFileType;
...
struct winSteamUGCRequestUGCDetailsResult_t_9784 {
    winSteamUGCDetails_t_158 m_details;
    bool m_bCachedData;
}  __attribute__ ((ms_struct));
#pragma pack( pop )
...
{
    lin_to_win_struct_SteamUGCDetails_t_158(&lin->m_details, &win->m_details);
