...
#pragma pack( pop )
void win_to_lin_struct_LeaderboardEntry_t_138(const void *w, void *l)
{
...
void lin_to_win_struct_LeaderboardEntry_t_138(const void *l, void *w)
{
    LeaderboardEntry_t *lin = (LeaderboardEntry_t *)l;
    struct winLeaderboardEntry_t_138 *win = (struct winLeaderboardEntry_t_138 *)w;
...
#pragma pack( pop )
void win_to_lin_struct_SteamUGCDetails_t_138(const void *w, void *l)
{
...
void lin_to_win_struct_SteamUGCDetails_t_138(const void *l, void *w)
{
    SteamUGCDetails_t *lin = (SteamUGCDetails_t *)l;
    struct winSteamUGCDetails_t_138 *win = (struct winSteamUGCDetails_t_138 *)w;
