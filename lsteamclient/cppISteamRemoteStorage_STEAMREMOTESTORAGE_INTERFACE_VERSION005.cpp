...
struct cppISteamRemoteStorage_STEAMREMOTESTORAGE_INTERFACE_VERSION005
{
#ifdef __cplusplus
    ...
    virtual uint64_t PublishFile( const char *, const char *, uint32_t, const char *, const char *, uint32_t, SteamParamStringArray_t * ) = 0;
    virtual uint64_t PublishWorkshopFile( const char *, const char *, uint32_t, const char *, const char *, SteamParamStringArray_t * ) = 0;
    virtual uint64_t UpdatePublishedFile( RemoteStorageUpdatePublishedFileRequest_t ) = 0;
...
{
    struct cppISteamRemoteStorage_STEAMREMOTESTORAGE_INTERFACE_VERSION005 *iface = (struct cppISteamRemoteStorage_STEAMREMOTESTORAGE_INTERFACE_VERSION005 *)params->linux_side;
