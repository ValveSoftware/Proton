...
struct cppISteamHTTP_STEAMHTTP_INTERFACE_VERSION001
{
#ifdef __cplusplus
...
{
    struct cppISteamHTTP_STEAMHTTP_INTERFACE_VERSION001 *iface = (struct cppISteamHTTP_STEAMHTTP_INTERFACE_VERSION001 *)params->linux_side;
