...
#pragma pack( pop )
void win_to_lin_struct_LeaderboardEntry_t_132x(const void *w, void *l)
{
    LeaderboardEntry_t *lin = (LeaderboardEntry_t *)l;
    struct winLeaderboardEntry_t_132x *win = (struct winLeaderboardEntry_t_132x *)w;
...
void lin_to_win_struct_LeaderboardEntry_t_132x(const void *l, void *w)
{
    LeaderboardEntry_t *lin = (LeaderboardEntry_t *)l;
    struct winLeaderboardEntry_t_132x *win = (struct winLeaderboardEntry_t_132x *)w;
...
#pragma pack( pop )
void win_to_lin_struct_SteamUGCDetails_t_132x(const void *w, void *l)
{
    SteamUGCDetails_t *lin = (SteamUGCDetails_t *)l;
    struct winSteamUGCDetails_t_132x *win = (struct winSteamUGCDetails_t_132x *)w;
...
void lin_to_win_struct_SteamUGCDetails_t_132x(const void *l, void *w)
{
    SteamUGCDetails_t *lin = (SteamUGCDetails_t *)l;
    struct winSteamUGCDetails_t_132x *win = (struct winSteamUGCDetails_t_132x *)w;
