...
typedef uint64_t XrCameraIdBD;
typedef uint64_t XrCameraImageIdBD;
...
typedef enum XrCameraPositionBD
{
    ...
    XR_CAMERA_POSITION_BD_MAX_ENUM = 0x7fffffff,
} XrCameraPositionBD;
...
typedef struct XrCameraCapabilityBaseHeaderBD
{
    XrStructureType type;
    const void *next;
...
typedef struct XrCameraImageDataBaseHeaderBD
{
    XrStructureType type;
    void *next;
...
typedef struct XrCameraPropertyBaseHeaderBD
{
    XrStructureType type;
    const void *next;
...
typedef struct XrCameraSupportedCapabilityBaseHeaderBD
{
    XrStructureType type;
    void *next;
...
typedef XrResult (XRAPI_PTR *PFN_xrAcquireCameraImageBD)(XrCameraCaptureSessionBD, const XrCameraImageAcquireInfoBD *, XrCameraImageBD *);
...
typedef XrResult (XRAPI_PTR *PFN_xrBeginCameraCaptureBD)(XrCameraCaptureSessionBD, const XrCameraCaptureBeginInfoBD *);
...
typedef XrResult (XRAPI_PTR *PFN_xrBeginSpatialContainerRenderingEXT)(XrSession, const XrSpatialContainerBeginInfoEXT *);
...
typedef XrResult (XRAPI_PTR *PFN_xrCheckVpsAvailabilityAsyncANDROID)(XrSession, double, double, XrFutureEXT *);
typedef XrResult (XRAPI_PTR *PFN_xrCheckVpsAvailabilityCompleteANDROID)(XrSession, XrFutureEXT, XrVPSAvailabilityCheckCompletionANDROID *);
...
typedef XrResult (XRAPI_PTR *PFN_xrCreateCameraCaptureSessionAsyncBD)(XrSession, const XrCameraCaptureSessionCreateInfoBD *, XrFutureEXT *);
typedef XrResult (XRAPI_PTR *PFN_xrCreateCameraCaptureSessionCompleteBD)(XrSession, XrFutureEXT, XrCreateCameraCaptureSessionCompletionBD *);
typedef XrResult (XRAPI_PTR *PFN_xrCreateCameraDeviceAsyncBD)(XrInstance, const XrCameraDeviceCreateInfoBD *, XrFutureEXT *);
typedef XrResult (XRAPI_PTR *PFN_xrCreateCameraDeviceCompleteBD)(XrInstance, XrFutureEXT, XrCreateCameraDeviceCompletionBD *);
...
typedef XrResult (XRAPI_PTR *PFN_xrCreateEyeTrackerANDROID)(XrSession, const XrEyeTrackerCreateInfoANDROID *, XrEyeTrackerANDROID *);
...
typedef XrResult (XRAPI_PTR *PFN_xrCreateGeospatialAnchorANDROID)(XrSpatialContextEXT, const XrGeospatialAnchorCreateInfoANDROID *, XrSpatialEntityIdEXT *);
typedef XrResult (XRAPI_PTR *PFN_xrCreateGeospatialTrackerANDROID)(XrSession, const XrGeospatialTrackerCreateInfoANDROID *, XrGeospatialTrackerANDROID *);
...
typedef XrResult (XRAPI_PTR *PFN_xrCreateLightEstimatorANDROID)(XrSession, XrLightEstimatorCreateInfoANDROID *, XrLightEstimatorANDROID *);
...
typedef XrResult (XRAPI_PTR *PFN_xrCreateSpatialContainerEXT)(XrSession, const XrSpatialContainerCreateInfoEXT *, XrSpatialContainerEXT *);
typedef XrResult (XRAPI_PTR *PFN_xrCreateSpatialContainerSpaceEXT)(XrSession, const XrSpatialContainerSpaceCreateInfoEXT *, XrSpace *);
...
typedef XrResult (XRAPI_PTR *PFN_xrCreateSpatialImageTrackingDatabaseAsyncEXT)(XrSession, const XrSpatialImageTrackingDatabaseCreateInfoEXT *, XrFutureEXT *);
typedef XrResult (XRAPI_PTR *PFN_xrCreateSpatialImageTrackingDatabaseCompleteEXT)(XrSession, XrFutureEXT, XrCreateSpatialImageTrackingDatabaseCompletionEXT *);
...
typedef XrResult (XRAPI_PTR *PFN_xrCreateSurfaceAnchorAsyncANDROID)(XrSpatialContextEXT, const XrSurfaceAnchorCreateInfoANDROID *, XrFutureEXT *);
typedef XrResult (XRAPI_PTR *PFN_xrCreateSurfaceAnchorCompleteANDROID)(XrSpatialContextEXT, XrFutureEXT, XrSurfaceAnchorCreateCompletionANDROID *);
...
typedef XrResult (XRAPI_PTR *PFN_xrDestroyCameraCaptureSessionBD)(XrCameraCaptureSessionBD);
typedef XrResult (XRAPI_PTR *PFN_xrDestroyCameraDeviceBD)(XrCameraDeviceBD);
...
typedef XrResult (XRAPI_PTR *PFN_xrDestroyEyeTrackerANDROID)(XrEyeTrackerANDROID);
...
typedef XrResult (XRAPI_PTR *PFN_xrDestroyGeospatialTrackerANDROID)(XrGeospatialTrackerANDROID);
...
typedef XrResult (XRAPI_PTR *PFN_xrDestroyLightEstimatorANDROID)(XrLightEstimatorANDROID);
...
typedef XrResult (XRAPI_PTR *PFN_xrDestroySpatialContainerEXT)(XrSpatialContainerEXT);
...
typedef XrResult (XRAPI_PTR *PFN_xrDestroySpatialImageTrackingDatabaseEXT)(XrSpatialImageTrackingDatabaseEXT);
...
typedef XrResult (XRAPI_PTR *PFN_xrEndCameraCaptureBD)(XrCameraCaptureSessionBD);
...
typedef XrResult (XRAPI_PTR *PFN_xrEndSpatialContainerRenderingEXT)(XrSession, const XrSpatialContainerEndInfoEXT *);
typedef XrResult (XRAPI_PTR *PFN_xrEnumerateApiLayerProperties)(uint32_t, uint32_t *, XrApiLayerProperties *);
typedef XrResult (XRAPI_PTR *PFN_xrEnumerateAvailableCamerasBD)(XrInstance, const XrAvailableCamerasEnumerateInfoBD *, uint32_t, uint32_t *, XrAvailableCameraBD *);
...
typedef XrResult (XRAPI_PTR *PFN_xrEnumerateCameraCapabilityTypesBD)(XrInstance, const XrCameraCapabilityTypesEnumerateInfoBD *, XrCameraCapabilityTypesBD *);
typedef XrResult (XRAPI_PTR *PFN_xrEnumerateCameraPropertyTypesBD)(XrInstance, const XrCameraPropertyTypesEnumerateInfoBD *, XrCameraPropertyTypesBD *);
typedef XrResult (XRAPI_PTR *PFN_xrEnumerateColorSpacesFB)(XrSession, uint32_t, uint32_t *, XrColorSpaceFB *);
typedef XrResult (XRAPI_PTR *PFN_xrEnumerateColorSpacesSONY)(XrSession, const XrColorSpacesEnumerateInfoSONY *, uint32_t, uint32_t *, XrColorSpaceSONY *);
...
typedef XrResult (XRAPI_PTR *PFN_xrEnumerateEnvironmentTexturePixelFormatsBD)(XrSession, uint32_t, uint32_t *, XrEnvironmentTexturePixelFormatBD *);
typedef XrResult (XRAPI_PTR *PFN_xrEnumerateEnvironmentTextureResolutionsBD)(XrSession, uint32_t, uint32_t *, XrEnvironmentTextureResolutionBD *);
typedef XrResult (XRAPI_PTR *PFN_xrEnumerateEnvironmentTextureTransferTypesBD)(XrSession, uint32_t, uint32_t *, XrEnvironmentTextureTransferTypeBD *);
...
typedef XrResult (XRAPI_PTR *PFN_xrEnumerateSpatialReferenceImageFormatsEXT)(XrInstance, XrSystemId, XrSpatialCapabilityEXT, uint32_t, uint32_t *, XrSpatialReferenceImageFormatEXT *);
...
typedef XrResult (XRAPI_PTR *PFN_xrEnumerateSupportedSpatialContainerGraphicsPresentationsEXT)(XrInstance, XrSystemId, uint32_t, uint32_t *, XrSpatialContainerGraphicsPresentationEXT *);
...
typedef XrResult (XRAPI_PTR *PFN_xrGetBodyTrackingStateBD)(XrSession, XrBodyTrackingStateBD *);
typedef XrResult (XRAPI_PTR *PFN_xrGetCameraImageDataBD)(XrCameraCaptureSessionBD, XrCameraImageIdBD, XrCameraImageDataBaseHeaderBD *);
typedef XrResult (XRAPI_PTR *PFN_xrGetCameraPropertiesBD)(XrInstance, const XrCameraPropertiesGetInfoBD *, XrCameraPropertiesBD *);
typedef XrResult (XRAPI_PTR *PFN_xrGetCameraSupportedCapabilitiesBD)(XrInstance, const XrCameraSupportedCapabilitiesGetInfoBD *, XrCameraSupportedCapabilitiesBD *);
typedef XrResult (XRAPI_PTR *PFN_xrGetCoarseTrackingEyesInfoANDROID)(XrEyeTrackerANDROID, const XrEyesGetInfoANDROID *, XrEyesANDROID *);
...
typedef XrResult (XRAPI_PTR *PFN_xrGetFineTrackingEyesInfoANDROID)(XrEyeTrackerANDROID, const XrEyesGetInfoANDROID *, XrEyesANDROID *);
...
typedef XrResult (XRAPI_PTR *PFN_xrGetLightEstimateANDROID)(XrLightEstimatorANDROID, const XrLightEstimateGetInfoANDROID *, XrLightEstimateANDROID *);
...
typedef XrResult (XRAPI_PTR *PFN_xrGetSpaceRoomMeshFaceIndicesMETA)(XrSpace, const XrUuid *, XrRoomMeshFaceIndicesMETA *);
typedef XrResult (XRAPI_PTR *PFN_xrGetSpaceRoomMeshMETA)(XrSpace, const XrSpaceRoomMeshGetInfoMETA *, XrRoomMeshMETA *);
...
typedef XrResult (XRAPI_PTR *PFN_xrGetSpatialContainerBoundsEXT)(XrSpatialContainerEXT, const XrSpatialContainerBoundsGetInfoEXT *, XrSpatialContainerBoundsEXT *);
typedef XrResult (XRAPI_PTR *PFN_xrGetSpatialContainerStateEXT)(XrSpatialContainerEXT, const XrSpatialContainerStateGetInfoEXT *, XrSpatialContainerStateEXT *);
...
typedef XrResult (XRAPI_PTR *PFN_xrGetStationaryReferenceSpaceGenerationIdEXT)(XrSession, const XrStationaryReferenceSpaceGenerationIdGetInfoEXT *, XrStationaryReferenceSpaceGenerationIdResultEXT *);
...
typedef XrResult (XRAPI_PTR *PFN_xrHapticParametricGetPropertiesEXT)(XrSession, const XrHapticActionInfo *, XrHapticParametricPropertiesEXT *);
...
typedef XrResult (XRAPI_PTR *PFN_xrLocateGeospatialPoseANDROID)(XrGeospatialTrackerANDROID, const XrGeospatialPoseLocateInfoANDROID *, XrSpaceLocation *);
typedef XrResult (XRAPI_PTR *PFN_xrLocateGeospatialPoseFromPoseANDROID)(XrGeospatialTrackerANDROID, const XrGeospatialPoseFromPoseLocateInfoANDROID *, XrGeospatialPoseResultANDROID *);
...
typedef XrResult (XRAPI_PTR *PFN_xrLocateSpatialContainerViewsEXT)(XrSession, const XrSpatialContainerViewsLocateInfoEXT *, uint32_t, XrSpatialContainerViewStateEXT *, uint32_t, XrView *);
...
typedef XrResult (XRAPI_PTR *PFN_xrReleaseCameraImageBD)(XrCameraCaptureSessionBD, XrCameraImageIdBD);
...
typedef XrResult (XRAPI_PTR *PFN_xrRequestBoundaryVisibilityMETA)(XrSession, XrBoundaryVisibilityMETA);
...
typedef XrResult (XRAPI_PTR *PFN_xrRequestSpatialContainerBoundsModeEXT)(XrSpatialContainerEXT, const XrSpatialContainerBoundsModeRequestInfoEXT *);
typedef XrResult (XRAPI_PTR *PFN_xrRequestSpatialContainerVisibleEXT)(XrSpatialContainerEXT, const XrSpatialContainerVisibleRequestInfoEXT *);
...
typedef XrResult (XRAPI_PTR *PFN_xrResultToString2KHR)(XrInstance, XrResult, char[]);
...
typedef XrResult (XRAPI_PTR *PFN_xrSetGoogleCloudAuthAsyncANDROID)(XrSession, const XrGoogleCloudAuthInfoBaseHeaderANDROID *, XrFutureEXT *);
typedef XrResult (XRAPI_PTR *PFN_xrSetGoogleCloudAuthCompleteANDROID)(XrSession, XrFutureEXT, XrFutureCompletionEXT *);
typedef XrResult (XRAPI_PTR *PFN_xrSetHandTrackingFrequencyHintMETA)(XrSession, XrHandTrackingFrequencyHintMETA);
typedef XrResult (XRAPI_PTR *PFN_xrSetHdrMetadataSONY)(XrSwapchain, const XrHdrMetadataSONY *);
...
typedef XrResult (XRAPI_PTR *PFN_xrStartBodyTrackingCalibrationAppBD)(XrSession);
...
XrResult XRAPI_CALL xrAcquireCameraImageBD(XrCameraCaptureSessionBD captureSession, const XrCameraImageAcquireInfoBD *acquireInfo, XrCameraImageBD *image);
...
XrResult XRAPI_CALL xrBeginCameraCaptureBD(XrCameraCaptureSessionBD captureSession, const XrCameraCaptureBeginInfoBD *beginInfo);
...
XrResult XRAPI_CALL xrCreateCameraCaptureSessionAsyncBD(XrSession session, const XrCameraCaptureSessionCreateInfoBD *createInfo, XrFutureEXT *future);
XrResult XRAPI_CALL xrCreateCameraCaptureSessionCompleteBD(XrSession session, XrFutureEXT future, XrCreateCameraCaptureSessionCompletionBD *completion);
XrResult XRAPI_CALL xrCreateCameraDeviceAsyncBD(XrInstance instance, const XrCameraDeviceCreateInfoBD *createInfo, XrFutureEXT *future);
XrResult XRAPI_CALL xrCreateCameraDeviceCompleteBD(XrInstance instance, XrFutureEXT future, XrCreateCameraDeviceCompletionBD *completion);
...
XrResult XRAPI_CALL xrDestroyCameraCaptureSessionBD(XrCameraCaptureSessionBD captureSession);
XrResult XRAPI_CALL xrDestroyCameraDeviceBD(XrCameraDeviceBD device);
...
XrResult XRAPI_CALL xrEndCameraCaptureBD(XrCameraCaptureSessionBD captureSession);
...
XrResult XRAPI_CALL xrEnumerateAvailableCamerasBD(XrInstance instance, const XrAvailableCamerasEnumerateInfoBD *enumerateInfo, uint32_t cameraCapacityInput, uint32_t *cameraCountOutput, XrAvailableCameraBD *cameras);
...
XrResult XRAPI_CALL xrEnumerateCameraCapabilityTypesBD(XrInstance instance, const XrCameraCapabilityTypesEnumerateInfoBD *enumerateInfo, XrCameraCapabilityTypesBD *capabilityTypes);
XrResult XRAPI_CALL xrEnumerateCameraPropertyTypesBD(XrInstance instance, const XrCameraPropertyTypesEnumerateInfoBD *enumerateInfo, XrCameraPropertyTypesBD *propertyTypes);
...
XrResult XRAPI_CALL xrGetCameraImageDataBD(XrCameraCaptureSessionBD captureSession, XrCameraImageIdBD imageId, XrCameraImageDataBaseHeaderBD *imageData);
XrResult XRAPI_CALL xrGetCameraPropertiesBD(XrInstance instance, const XrCameraPropertiesGetInfoBD *getInfo, XrCameraPropertiesBD *properties);
XrResult XRAPI_CALL xrGetCameraSupportedCapabilitiesBD(XrInstance instance, const XrCameraSupportedCapabilitiesGetInfoBD *getInfo, XrCameraSupportedCapabilitiesBD *capabilities);
...
XrResult XRAPI_CALL xrReleaseCameraImageBD(XrCameraCaptureSessionBD captureSession, XrCameraImageIdBD imageId);
...
XrResult XRAPI_CALL xrResultToString2KHR(XrInstance instance, XrResult value, char buffer[]);
